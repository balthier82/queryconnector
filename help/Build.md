...
* download **mingw32-make** from (http://sourceforge.net/projects/mingw/files/MinGW/Extension/make/) (example **mingw32-make-3.81-xxxxxxxx.tar.gz**), unzip it to any directory and put this directory to the **PATH** enviroment variable.
