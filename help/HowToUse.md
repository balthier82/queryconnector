...
> You have to ensure that the driver JDBC that you intend to use is installed and configured correctly. The .jar file of the driver have to be inserted on the LibreOffice/OpenOffice classpath. Go to **Tools->Options->Advanced->** then click on the
